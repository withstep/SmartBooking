...
div(class="time-picker-modal-container")
	div(class="time-picker-modal-header")
		span(class="time-picker-header" ':class'="{active:!step}") {{hourString}}
		| &nbsp;:&nbsp;
		span(class="time-picker-header" ':class'="{active:step}") {{minuteString}}
	div(class="picker-container")
		time-picker-generator(':handle-time-pointer-click'="handleTimePointerClick" ':type'="timeType" ':hour'="hour" ':minute'="minute" ':count'="count")

</template>

<script>
import { HOURS, MINUTES } from "../constValues.js";
  ...
  methods: {
    handleStepChange(s) {
      if (s != this.step) {
        this.step = s;
        this.pointerRotate =
          s == 0 ? this.resetHourDegree() : this.resetMinuteDegree();
      }
    },
