...
div
	div(v-if="type=='minute'" id="picker-pointer-container")
		...
		div(class="interval-container")
			span(class="time-picker-interval") {{ count }}명
	div(v-else id="picker_pointer_container")
		...
		div(class="interval-container")
			span(@click="handleIntervalChange('AM')" class="time-picker-interval" ':class'="{active:interval=='AM'}") 오전
			| &nbsp;|&nbsp;
			span(@click="handleIntervalChange('PM')" class="time-picker-interval" ':class'="{active:interval=='PM'}") 오후

</template>

<script>
import PickerPoints from "./PickerPoints";
import { MINUTES, HOURS, TWELVE_HOURS } from "../constValues.js";
export default {
	props: {
		type: {
			type: String,
